...
// const tlPogetEndpoint = "/something";
// const sdaPogetEndpoint = "/something-else";

// const frontEndError = {
// 	data: {
// 		errors: [{ code: 0, message: "We are unable to complete your request.  Please try again." }]
// 	}
// };
// const htmlError = {
// 	data: {
// 		errors: [{ code: 1, message: "Invalid response - the application cannot process your request" }]
// 	}
// };
...
// 		  }
// 		: { "Content-Type": "application/json", "X-B3-TraceId": `${logId}`, "X-B3-SpanId": `${logId}` };
// 	return headers;
// };
...
// 			return "/this-stuff";
// 		} else {
// 			// return "http://another-route/stuff";
// 		}
// 	}
// };
...
// 				return new Promise((resolve) => resolve(errorParser(res, headers["X-B3-TraceId"])));
// 			} else {
// 				return new Promise((resolve) => resolve(res));
// 			}
// 		})
// 		.catch((error) => {
// 			console.log(`GET Error (${headers["X-B3-TraceId"]}): `, error.response ? error.response : error);
// 			return new Promise((resolve) => resolve(errorParser(error.response, headers["X-B3-TraceId"])));
// 		});
// };
...
// 		})
// 		.catch((error) => {
// 			console.log(`POST Error (${headers["X-B3-TraceId"]}): `, error.response ? error.response : error);
// 			return new Promise((resolve) => resolve(errorParser(error.response, headers["X-B3-TraceId"])));
// 		});
// };
...
// 		})
// 		.catch((error) => {
// 			console.log(`PUT Error (${headers["X-B3-TraceId"]}): `, error.response ? error.response : error);
// 			return new Promise((resolve) => resolve(errorParser(error.response, headers["X-B3-TraceId"])));
// 		});
// };
...
// 		})
// 		.catch((error) => {
// 			console.log(`DELETE Error (${headers["X-B3-TraceId"]}): `, error.response ? error.response : error);
// 			return new Promise((resolve) => resolve(errorParser(error.response, headers["X-B3-TraceId"])));
// 		});
// };
...
// 	if (postType === "abc") {
// 		pogetData = { "@type": "abc-stuff", ...data };
// 		postUrl = abcEndpoint;
// 	}
// 	if (postType === "xyz") {
// 		pogetData = { "@type": "xyz-stuff", ...data };
// 		postUrl = xyzEndpoint;
// 	}
...
// 		.then((res) => {
// 			if (res.status === 226) {
// 				console.log(`POGET First Stage Error (${headers["X-B3-TraceId"]}): `, res);
// 				return new Promise((resolve) => resolve(errorParser(res, headers["X-B3-TraceId"])));
// 			} else {
...
// 							console.log(`POGET Second Stage Error (${headers["X-B3-TraceId"]}): `, getRes);
// 							return new Promise((resolve) => resolve(errorParser(getRes, headers["X-B3-TraceId"])));
// 						} else {
// 							return new Promise((resolve) => resolve(getRes));
// 						}
// 					})
// 					.catch((getError) => {
// 						console.log(`POGET Second Stage Error (${headers["X-B3-TraceId"]}): `, getError.response ? getError.response : getError);
// 						return new Promise((resolve) => resolve(errorParser(getError.response, headers["X-B3-TraceId"])));
// 					});
// 			}
// 		})
// 		.catch((error) => {
// 			console.log(`POGET First Stage Error (${headers["X-B3-TraceId"]}): `, error.response ? error.response : error);
// 			return new Promise((resolve) => resolve(errorParser(error.response, headers["X-B3-TraceId"])));
// 		});
// };
